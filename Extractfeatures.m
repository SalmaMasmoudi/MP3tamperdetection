function [  main_data_begin ] = Extractfeatures( file_name )
    load data.mat index_bg_region bg_region indice1 x
   ...
   % out_PCM_samples = [];
    main_data_begin= [];
 feature1 (1:4,:)=double(0);
 feature2 (1:4,:)=uint16(0);
 feature3 (1:4,:)=uint8(0);
 feature4 (1:4,:)=uint8(0);
 feature5 (1:4,:)=uint8(0);
 feature6=[]; %(1:4,:)=uint8(0);
 feature7=[]; %(1:4,:)=uint8(0);
 feature8=[];
 feature9=[];
 feature10=[];
 feature11=[];
 ...
 %-------------------------------------------------------------------------
                ...
                if ( strcmp(mode,'single_channel') )                        
                    ...
                    main_data_begin=[main_data_begin;i];
                   feature6=[feature6 table_select];
                   feature7=[feature7 subblock_gain];
                   feature8=[feature8 part2_length];
                  feature9=[feature9 pre_flag];
                   feature10=[feature10 scalefac_scale];
                   feature11=[feature11 count1table_select];
